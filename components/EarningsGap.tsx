...
interface Res { data: EarningsRow[]; updatedAt: string }
...
export default function EarningsGap() {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-3 grid grid-cols-2 gap-2 text-[10px] text-t-dim">
        <div className="border border-t-border/50 p-2 rounded"><span className="text-t-green">STRONG BUY</span> — surprise &gt;15% AND gap &gt;3%</div>
        <div className="border border-t-border/50 p-2 rounded"><span className="text-t-green">BUY</span> — EPS surprise &gt;5%</div>
        <div className="border border-t-border/50 p-2 rounded"><span className="text-t-dim">NEUTRAL</span> — no significant move</div>
        <div className="border border-t-border/50 p-2 rounded"><span className="text-t-red">SELL</span> — EPS miss &gt;10%</div>
      </div>
    </div>
  );
}
